...
class TestTimeUtils(unittest.TestCase):
    ...
    def test_alert_time_timed_out(self):
        timer = timeUtils.get_alert_time("Scaduta")
        self.assertEqual(timer, "Scaduta")
